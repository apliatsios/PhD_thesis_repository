...
def add_api_data(tx, name, api_name, pm2_5, pm10, so2, no2, o3, long, lat, timestamp):
    ...
    tx.run("MERGE (a:Open_Data_Entity{label: \"Open_Data_Entity\", name: \"Open_Data_Entity_\"+$name})-[:hasPlatform]->(b:Open_Data_Platform{label: \"Open_Data_Platform\", name: $api_name})"
